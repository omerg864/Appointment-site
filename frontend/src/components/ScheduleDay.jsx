...
function ScheduleDay({title, data, setData, unique, index, containerStyles}){
    ...
    <FloatingLabelInput label="Interval" value={data ? data.interval : ""} unique={unique} setValue={setData} indexed={index} props={{required: true, type: "text", name: "interval"}} containerStyle={{width: '100%', marginBottom: '10px'}}/>
